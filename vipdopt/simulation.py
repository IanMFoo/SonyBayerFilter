...
class LumericalSimulation(ISimulation):
    ...
    def connect(self, license_checked:bool = True) -> None:
        ...
        while self.fdtd is None:
            try:
                ...
                # vipdopt.fdtd = vipdopt.lumapi.FDTD(hide=False)             #! Need to turn the Lumerical GUI on for debugging
    ...
    def import_cur_index(self, design,
        ...
        for dispersive_range_idx in range(0, 1):		
    ...
    def get_field(self, monitor_name: str, field_indicator: str) -> npt.NDArray:
        ...
        # return fields.squeeze()                  # Maybe we shouldn't squeeze - need to account for 2D/3D
        return fields
